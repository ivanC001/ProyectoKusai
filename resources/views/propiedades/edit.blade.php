        ...
        <form class="panel" action="{{ route('propiedades.update', $propiedad) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid">
                ...
                <div class="field span-4">
                    ...
                    <select id="tipo_propiedad_id" name="tipo_propiedad_id">
                        ...
                        @foreach ($tiposPropiedad as $tipo)
                            <option value="{{ $tipo->id }}" @selected((string) old('tipo_propiedad_id', $propiedad->tipo_propiedad_id) === (string) $tipo->id)>{{ $tipo->nombre }}@if(str_contains(mb_strtolower($tipo->nombre), 'proyecto')) (proyecto)@endif</option>
                        @endforeach
                    </select>
                ...
                <div class="project-hint" id="project-hint">
                    <strong>Edicion de proyecto inmobiliario:</strong> esta publicacion se mostrara en la seccion Proyectos.
                    <ul class="project-hint-list">
                        <li>Operacion obligatoria: <strong>Venta</strong>.</li>
                        <li>Usa un titulo con nombre del proyecto + zona para que se identifique rapido.</li>
                        <li>Incluye en descripcion etapas, fecha estimada de entrega, precios desde y metrajes.</li>
                    </ul>
                </div>
                ...
                <div class="field span-2">
                    ...
                    <input id="precio_usd" name="precio_usd" type="number" step="0.01" min="0" value="{{ old('precio_usd', $propiedad->precio_usd) }}" placeholder="35000">
            ...
            <div class="grid">
                ...
                <div class="field span-6">
                    ...
                    <input id="direccion" name="direccion" type="text" value="{{ old('direccion', $propiedad->direccion) }}" placeholder="Av. Principal 123, Urbanizacion, Calle, Nro.">
                    @error('direccion') <span class="error-text">{{ $message }}</span> @enderror
                </div>

                <div class="field span-6">
                    <label for="referencia">REFERENCIA</label>
                    <input id="referencia" name="referencia" type="text" value="{{ old('referencia', $propiedad->referencia) }}" placeholder="Frente al parque, cerca al mercado, etc.">
